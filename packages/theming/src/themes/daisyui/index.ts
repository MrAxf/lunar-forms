...
const theme: DeepPartial<PluginOptions['theme']> = {
  classes: {
    ...
    groups: {
      ...
      inputText: {
        input: 'input bg-base-300 w-full appearance-none ![isolation:unset] lunar-prefix:rounded-l-none lunar-suffix:rounded-r-none',
